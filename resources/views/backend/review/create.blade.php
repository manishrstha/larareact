					...
					<div class="card-body">
						...
						<form action="{{route('review.store')}}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control mb-4 input-rounded" id="name" name="name" type="text" placeholder="Enter reviewer name">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea class="form-control mb-4 input-rounded" id="review" name="review" placeholder="Enter review"></textarea>
							</div>
							<div class="form-group">

					...
					<div class="card-body">
						...
						<form action="{{route('slider.update',$slider->id)}}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control mb-4 input-rounded" id="slogan" name="slogan" type="text" placeholder="Enter slider slogan" value="{{$slider->slogan}}">
							</div>
							...
							<div class="form-group">
								...
								<textarea class="form-control mb-4 input-rounded" id="description" name="description" placeholder="Enter description">{{$slider->description}}</textarea>
							</div>
							<div class="form-group">
								<label for="link">Url</label>
								<input class="form-control mb-4 input-rounded" id="link" name="link" type="url" placeholder="Enter slider link" value="{{$slider->link}}">
							</div>
							<div class="form-group">

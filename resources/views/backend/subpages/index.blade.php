	...
	<div class="sales-report-area mt-3 mb-3">
		<div class="row">
			<div class="col-12 text-right">
				<a class="btn btn-success" href="{{ route('subpage.create') }}">Add New Subpage</a>
			</div>
			<div class="col-12 mt-5">
				<div class="card">
					<div class="card-body">
						<h4 class="header-title">Subpages</h4>
							...
							<table id="dataTable" class="text-center">
								...
								<tbody>
									...
									<tr>
										<td>{{ $sub_page->name }}</td>
										@php 
										$page = App\Page::findOrFail($sub_page->page_id);
										@endphp
										<td><a href="{{route('page.show',$sub_page->page_id)}}"> {{ $page->page_name }} </a></td>
